  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row items-center justify-between px-8 py-16 bg-white space-y-8 lg:space-y-0 lg:space-x-8">
      ...
      <div className="relative flex-shrink-0">
        <div className="absolute -top-6 -left-6 w-48 h-48 bg-blue-500 rounded-lg z-0"></div>
        <div className="absolute top-10 left-6 w-48 h-48 bg-blue-400 rounded-lg z-0"></div>
